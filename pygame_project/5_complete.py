...
background = pygame.image.load(
    "/Users/Avery/Desktop/python/game/pygame_project/images/background.png")

# 스프라이트(캐릭터) 불러오기
character = pygame.image.load(
    "/Users/Avery/Desktop/python/game/pygame_project/images/character3.png")
...
weapon = pygame.image.load(
    "/Users/Avery/Desktop/python/game/pygame_project/images/weapon2.png")
...
enemy_images = [
    pygame.image.load(
        "/Users/Avery/Desktop/python/game/pygame_project/images/enemy2.png"),
    pygame.image.load(
        "/Users/Avery/Desktop/python/game/pygame_project/images/enemy3.png"),
    pygame.image.load(
        "/Users/Avery/Desktop/python/game/pygame_project/images/enemy4.png"),
    pygame.image.load("/Users/Avery/Desktop/python/game/pygame_project/images/enemy5.png")]

# 공 크기에 따른 최초 스피드
enemy_speed_y = [-18, -15, -13, -11]  # index 0, 1, 2, 3 에 해당하는 값
...
while running:
    dt = clock.tick(25)  # 게임화면의 초당 프레임 수를 설정
    ...
    for enemy_idx, enemy_val in enumerate(enemys):
        ...
        for weapon_idx, weapon_val in enumerate(weapons):
            ...
            if weapon_rect.colliderect(enemy_rect):
                ...
                if enemy_img_idx < 3:
                    # 현재 공 크기 정보를 가지고 옴
                    ball_width = enemy_rect.size[0]
                    ball_height = enemy_rect.size[1]
